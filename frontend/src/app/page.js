...
export default function Home() {
  ...
  // Fetch the Retro NFT balance of the user
  const nftBalanceOfUser = useContractRead({
    abi: RetroNFTABI,
    address: RetroNFTAddress,
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any Retro NFTs. <br />
  ...
  return (
    <div className={inter.className}>
      <Head>
        <title>Retro DAO</title>
        <meta name='description' content='Retro DAO' />
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your Retro NFT Balance: {nftBalanceOfUser.data?.toString()}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{' '}
