export const RetroNFTAddress = '0x8FB60F418FbD32246b3d0f547ee20F16B31e76D9';
export const NFTMarketplaceAddress =
  '0xbE7923c13DE419C359dF7c43B64d2a925c91717B';
export const RetroDAOAddress = '0x7665166c10c3BCccC977e303044Ad912EA833f21';

export const RetroNFTABI = [
...
export const RetroDAOABI = [
  {
    inputs: [
      { internalType: 'address', name: '_nftMarketplace', type: 'address' },
      { internalType: 'address', name: '_retroNFT', type: 'address' },
    ],
    stateMutability: 'payable',
    type: 'constructor',
  },
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'proposalIndex', type: 'uint256' },
      { internalType: 'enum RetroDAO.Vote', name: 'vote', type: 'uint8' },
    ],
    name: 'voteOnProposal',
    outputs: [],
    stateMutability: 'nonpayable',
